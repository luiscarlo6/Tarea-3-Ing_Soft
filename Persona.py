class Persona(object):
    ...
    def __init__(self, nombre, apellido, institucion, pais):
        
        
        if (isinstance(nombre, str) and isinstance(apellido, str) and 
            isinstance(institucion, str) and isinstance(pais, str)):
...
class Autor(Persona):
    ...
    def __init__(self, nom, ape, ins, pai):
        super(Autor, self).__init__(nom, ape, ins, pai)
...
class CP(Persona):
    ...
    def __init__(self, nom, ape, ins, pai, topicos, es_pre):
        super(CP, self).__init__(nom, ape, ins, pai)
        if not isinstance(es_pre, bool):
            raise TypeError
        else:
            self.__topicos = topicos 
            self.__es_presidente = es_pre
